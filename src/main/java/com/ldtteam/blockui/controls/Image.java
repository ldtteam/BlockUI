...
public class Image extends Pane 
{
    ...
    {
        if (OutOfJarResourceLocation.fileExists(rl.withSuffix(".mcmeta"), Minecraft.getInstance().getResourceManager()))
        {
            final SpriteContents sprite = SpriteLoader.loadSprite(rl,
    ...
    public class SpriteTexture extends DynamicTexture implements Tickable
    {
        ...
        public SpriteTexture(final int width, final int height, final SpriteContents sprite)
        {
