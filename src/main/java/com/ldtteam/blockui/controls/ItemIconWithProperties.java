 ...
 *
 * TODO: what to do with this stuff, we could do DataComponent overrides, though it's far from one-to-one replacement with modelProperties
 */
public class ItemIconWithProperties extends ItemIcon
{
    ...
    public ItemIconWithProperties(final PaneParams paneParams)
    {
        ...
        {
            // TODO: this would parse the properties with fixed values (that's the easier part)
    ...
    public void drawSelf(final BOGuiGraphics target, final double mx, final double my)
    {
        ...
        // TODO: this would replace the property inside the selected itemModel (that's the impossible part)
    ...
    private record ItemPropertyFunction(ConditionalItemModelProperty conditional,
        RangeSelectItemModelProperty rangeSelect,
        SelectItemModelProperty<?> select)
    {}
}
