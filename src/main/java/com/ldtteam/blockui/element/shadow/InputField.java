...
public class InputField extends AbstractShadowGroupPane implements RenderSetters, AccessibleId, AccessibleEnabled
{
    public InputField(final AbstractPaneGroup parent)
    {
        super(parent);
    }
}
